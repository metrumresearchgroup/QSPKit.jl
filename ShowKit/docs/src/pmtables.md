...
ShowKit wraps MetrumRG's [pmtables](https://metrumresearchgroup.github.io/pmtables/) package for creating pharmacometric summary tables as LaTeX output. Tables are built with a pipeline pattern using `|>`.
