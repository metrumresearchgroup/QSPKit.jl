...
ShowKit wraps MetrumRG's [mrggsave](https://github.com/metrumresearchgroup/mrggsave) package for saving ggplot objects with provenance annotation. Every saved figure is automatically stamped with the script name and output filename, making figures self-documenting.
