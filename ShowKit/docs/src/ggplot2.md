...
ggplot2 extensions (ggrepel, ggforce, patchwork, ggdist, etc.) work via the escape hatch, as long as they're installed in R:

```julia
# Install once in R
# CondaR loaded automatically by ShowKit
R"install.packages('ggrepel', repos='https://cloud.r-project.org')"
