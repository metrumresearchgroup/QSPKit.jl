...
- `kwargs...`: Default solver keyword arguments (for example, `reltol=1e-4`, `maxiters=200000`, `saveat=[2000.0]`)

# Example
```julia
sim = SimContext(prob; solver=OrdinaryDiffEqBDF.QNDF(), reltol=1e-4, maxiters=200000)
```
