...
# computation, exactly as the user wrote `up = lookup("MU1"); book!("MU2", ...)`.
# ──────────────────────────────────────────────────────────────────────────
...
# Arguments
- `name::String` — identifier for this result (e.g., "MU2")
...
function book!(name::String, status::Symbol;
    ...
    # Phase 3: capture the package environment. Julia VERSION (+ Manifest hash) ride
