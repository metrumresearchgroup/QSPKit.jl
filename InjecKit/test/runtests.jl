...
@testset verbose=true "InjecKit.jl Tests" begin
    ...
    @testset "Plotting Utilities Tests" begin
    ...
    @testset "Prepared execution API" begin
    ...
    @testset "Performance Considerations" begin
        @testset "Large Event Datasets" begin
            # Test with moderately large dataset
            n_events = 50
            large_df = DataFrame(
                TIME = sort(rand(n_events) * 24.0),
...
include("test_infusion_boundaries.jl")
